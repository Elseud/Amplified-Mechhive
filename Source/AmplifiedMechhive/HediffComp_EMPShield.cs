...
{
    [HotSwappable]
    public class HediffComp_EMPShield : HediffComp
    {
        ...
        public void Break()
        {
            ...
            GenExplosion.DoExplosion(parent.pawn.Position, parent.pawn.MapHeld, Props.shieldExplosionRadius, AM_DefOf.AM_ShieldExplosion, parent.pawn);
        }
    ...
    [HotSwappable]
    public class HediffCompProperties_EMPShield : HediffCompProperties
    {
